...
root = ThemedTk(theme="clearlooks")  # Try: arc, plastik, clearlooks, equilux, etc.
...
college_var = ttk.Combobox(frame_input, values=["", "College of Engineering", "College of Computer Science"], width=30)
